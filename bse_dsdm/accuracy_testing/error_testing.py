from sklearn.metrics import roc_auc_score, accuracy_score, precision_score, recall_score, r2_score, confusion_matrix, f1_score, matthews_corrcoef, balanced_accuracy_score

def evaluate_classification_metrics(y_true, y_pred):
    """
    Evaluate various classification metrics and print a summary.
